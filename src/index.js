...
let p1 = new Promise((resolve, reject) => FhirJsonFetcher.handlePages(allResources, allDataTypes, allMetadataTypes));
p1.then(result => FhirResourceFileGenerator.buildFiles(result.resources, result.dataTypes));