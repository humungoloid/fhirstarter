...
const primitiveTypes = (() => {
	let types = {
		...
		string: { default: 'UNKNOWN', type: 'string', regex: STRING_REGEX },
		decimal: {
			default: 0,
			type: 'number',
...
const getPrimitive = (valueType) => primitiveTypes[valueType];
const isPrimitive = (valueType) => primitiveTypes[valueType] !== undefined;

export { primitiveTypes, isPrimitive, getPrimitive };
